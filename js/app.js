    ...
    container.innerHTML = `
        <div class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white p-6 rounded-xl shadow-sm"><p class="text-sm text-slate-500">累计总佣金</p><p class="text-3xl font-bold mt-1">¥${totalCommission.toFixed(2)}</p></div>
                <div class="bg-white p-6 rounded-xl shadow-sm"><p class="text-sm text-slate-500">可提现佣金</p><p id="dist-withdrawable-commission" class="text-3xl font-bold mt-1 text-green-600">¥${withdrawableCommission.toFixed(2)}</p></div>
                <div class="bg-white p-6 rounded-xl shadow-sm"><p class="text-sm text-slate-500">我的客户数</p><p class="text-3xl font-bold mt-1">${distributionData.customers.length}</p></div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-sm lg:col-span-2">
                    ...
                    <div id="earnings-chart" class="h-48 flex items-end justify-between gap-x-2 sm:gap-x-4"></div>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-sm text-center">
                    ...
                    <div class="mt-4">
                        <input type="text" id="referral-link" value="https://iboxify.com/ref?id=12345" class="w-full text-center border-slate-300 rounded-md bg-slate-50 text-sm" readonly>
                        <button onclick="copyReferralLink(this)" class="mt-2 w-full text-sm font-semibold text-blue-600 hover:underline">复制推广链接</button>
                    </div>
                    <button onclick="openWithdrawalModal()" class="mt-6 w-full btn-primary text-white py-2.5 rounded-lg font-semibold flex items-center justify-center">
